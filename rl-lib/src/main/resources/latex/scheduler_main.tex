...
\hspace*{0.20in}\it scheduler\_main

\bf INCLUDES

\hspace*{0.20in}\it scheduler

\bf PROMOTES

\hspace*{0.20in}\it delete\rm , \it activate

\bf DEFINITIONS

\hspace*{0.20in}\it SET\_PREF\_MAXINT \rm == \rm 1\rm 0\rm 0\rm 0\rm 0\rm 0 \rm ;
